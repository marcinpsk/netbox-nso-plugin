...
class TestReconcileBgpConfig(IntentPushResetMixin, TestCase):
    ...
    def test_unmanaged_peer_group_template_policy_is_preserved_as_conflict(self):
        ...
        native_remote_as = ASN.objects.get(asn=65100)
        template = BGPPeerTemplate.objects.create(name="UNMANAGED-GROUP", remote_as=native_remote_as)
        ...
        self.assertEqual(template.remote_as_id, native_remote_as.pk)
